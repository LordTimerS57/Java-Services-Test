...
public class User {
    ...
    /** true = non bloqué (oui), false = bloqué (non). */
    @Column(nullable = false)
    private boolean status = true;

    /** État de connexion : true = connecté (actif), false = non connecté. */
    ...
    public User(String matricule, String nom, String prenom, String email, String motDePasse, Role role) {
    ...
    /** true = non bloqué, false = bloqué. */
    public boolean isStatus() { return status; }
    public void setStatus(boolean status) { this.status = status; }

    /** true = connecté (actif), false = non connecté. */
